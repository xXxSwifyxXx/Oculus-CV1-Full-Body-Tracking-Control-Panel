/*
 * File: src/core/anti_sleep_service.cpp
 *
 * Purpose:
 *   Implements the periodic anti-sleep refresh behavior and writes runtime state information consumed by the control panel.
 *
 * Design Notes:
